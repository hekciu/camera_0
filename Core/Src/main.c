...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, CS_CAMERA_Pin|SIO_D_Pin|SIO_C_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : CS_CAMERA_Pin */
  GPIO_InitStruct.Pin = CS_CAMERA_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(CS_CAMERA_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : SIO_D_Pin SIO_C_Pin */
  GPIO_InitStruct.Pin = SIO_D_Pin|SIO_C_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
